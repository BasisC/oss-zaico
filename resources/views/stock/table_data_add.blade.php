                    ...
                    @foreach($forms as $form)
                        ...
                        @switch($form->form_type_id)
                            ...
                            <div class="form-group{{ $errors->has($col_name) ? ' has-error' : '' }}">
                                <label for="classification_id" class="col-md-4 control-label">{{$form->col_name->getName()}}</label>
                                <div class="col-md-6">
                                    <textarea name="{{$col_name}}" rows="4" cols="40"  class ="form-control"></textarea>
                                    @if ($errors->has($col_name))
                                        <span class="help-block">
                                        <strong>{{ $errors->first($col_name) }}</strong>
                                    </span>
                            ...
                            <div class="form-group{{ $errors->has($col_name) ? ' has-error' : '' }}">
                                <label for="classification_id" class="col-md-4 control-label">{{$form->col_name->getName()}}</label>
                                <div class="col-md-6">
                                    <input type="number"  class ="form-control" name="{{$col_name}}">
                                    @if ($errors->has($col_name))
                                        <span class="help-block">
                                        <strong>{{ $errors->first($col_name) }}</strong>
                                    </span>
                            ...
                            <div class="form-group{{ $errors->has($col_name) ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    @foreach($form->selects as $obj)
                                        <input type="radio" name="{{$col_name}}" value= "{{$obj->id}}" > {{$obj->select_value}}<br>
                                    @endforeach
                                        @if ($errors->has($col_name))
                                            <span class="help-block">
                                        <strong>{{ $errors->first($col_name) }}</strong>
                            ...
                            <div class="form-group{{ $errors->has($col_name) ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    @foreach($form->selects as $obj)
                                        <input type="checkbox" name="{{$col_name}}[]" value="{{$obj->id}}" >{{$obj->select_value}}<br>
                                    @endforeach
                                        @if ($errors->has($col_name))
                                            <span class="help-block">
                                        <strong>{{ $errors->first($col_name) }}</strong>
                            ...
                            <div class="form-group{{ $errors->has($col_name) ? ' has-error' : '' }}">
                                <label for="classification_id" class="col-md-4 control-label">{{$form->col_name->getName()}}</label>
                                <div class="col-md-6">
                                    <input type="email" name="{{$col_name}}" size="30" maxlength="40"  class ="form-control">
                                    @if ($errors->has($col_name))
                                        <span class="help-block">
                                        <strong>{{ $errors->first($col_name) }}</strong>
                                    </span>
                        ...
                        datetime
                            <div class="form-group{{ $errors->has($col_name) ? ' has-error' : '' }}">
                                <label for="classification_id" class="col-md-4 control-label">{{$form->col_name->getName()}}</label>
                                <div class="col-md-6">
                                    <input type="datetime-local" name="{{$col_name}}" value="2019-01-01T12:00">
                                    @if ($errors->has($col_name))
                                        <span class="help-block">
                                        <strong>{{ $errors->first($col_name) }}</strong>
                                    </span>
